  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {findings.length === 0 && <EmptyState icon={CheckCircle2} message="No vulnerable dependencies detected" />}
        {findings.map((finding) => (
          <div key={finding.$id} className="card bg-neutral-900 rounded-lg border border-neutral-800 p-5 hover:border-[var(--accent-primary)]/30 transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1.5">
                    ...
                    <span className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-widest">{finding.tool}</span>
                  </div>
                </div>
              </div>

                    ...
                    <section className={`premium-card rounded-2xl p-10 ${theme === 'liquid-glass' ? 'liquid-glass' : ''}`}>
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8 mb-12 pb-12 border-b border-[var(--border-subtle)]">
                            <div className="relative group">
                                ...
                                <label className="absolute -bottom-2 -right-2 w-10 h-10 bg-[var(--accent-primary)] rounded-2xl flex items-center justify-center text-white cursor-pointer shadow-lg hover:scale-110 transition-transform">
                                    <Camera size={18} />
                                    <input type="file" className="hidden" accept="image/*,.jpg,.jpeg,.png,.gif,.bmp,.webp,.svg,.tiff,.ico" onChange={handleAvatarUpload} disabled={uploading} />
                                </label>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-6 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-subtle)] space-y-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 bg-[#4A154B]/40 rounded-2xl flex items-center justify-center">
                                ...
                                {prefSlack && (
                                    <div className="space-y-2 animate-in slide-in-from-top-2 duration-200">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-5 py-3 bg-[var(--bg-primary)] border border-[var(--border-subtle)] rounded-2xl font-mono text-[10px] outline-none focus:ring-4 focus:ring-[var(--accent-primary)]/10 focus:border-[var(--accent-primary)] text-[var(--text-primary)] transition-all placeholder:text-[var(--text-secondary)]/40"
                                        />
                            ...
                            <div className="p-6 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-subtle)] space-y-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 bg-[#5865F2]/20 rounded-2xl flex items-center justify-center">
                            ...
                            <div className="flex items-center gap-3 px-4 py-3 bg-red-500/5 border border-red-500/20 rounded-2xl">
                                ...
                                <div key={repo.$id} className="flex justify-between items-center p-6 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-subtle)]">
                                    ...
                                    <div className="flex items-center gap-6">
                                        <select
                                            ...
                                            className="bg-[var(--bg-primary)] border border-[var(--border-subtle)] rounded-2xl px-4 py-2 text-[10px] font-black italic uppercase text-[var(--text-primary)] outline-none"
                                        >
                    ...
                    <section className={`premium-card rounded-2xl p-10 ${theme === 'liquid-glass' ? 'liquid-glass' : ''}`}>
                        ...
                        {generatedKey && (
                            <div className="mb-8 p-6 bg-[var(--status-success)]/10 border border-[var(--status-success)]/20 rounded-2xl">
                                ...
                                <code className="block bg-[var(--bg-primary)] text-[var(--status-success)] p-4 rounded-2xl font-mono text-sm break-all border border-[var(--status-success)]/30">
                                    {generatedKey}
                                </code>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex gap-4">
                                    <button
                                        ...
                                        className={`flex-1 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${echoMovementEnabled ? 'bg-cyan-500 text-black shadow-lg shadow-cyan-500/20 opacity-40 cursor-not-allowed' : 'bg-cyan-500 text-black hover:scale-[1.02] active:scale-[0.98]'}`}
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${!echoMovementEnabled ? 'bg-white/5 border border-white/10 text-[var(--text-secondary)] opacity-40 cursor-not-allowed' : 'bg-white/5 border border-white/10 text-[var(--text-primary)] hover:bg-white/10 hover:scale-[1.02] active:scale-[0.98]'}`}
                                        disabled={!echoMovementEnabled}
                                    >

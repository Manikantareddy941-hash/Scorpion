    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-[var(--text-secondary)] text-sm mt-2 font-medium uppercase tracking-widest opacity-70">
          Immutable forensic trail of all security operations
        </p>
      </div>

      <div className="premium-card overflow-hidden">
        <div className="bg-[var(--bg-primary)]/50 border-b border-[var(--border-subtle)] px-6 py-3 grid grid-cols-12 gap-4">
          <div className="col-span-2 text-[10px] font-black uppercase tracking-widest text-[var(--text-secondary)]">Action</div>
          <div className="col-span-4 text-[10px] font-black uppercase tracking-widest text-[var(--text-secondary)]">Resource</div>
          <div className="col-span-3 text-[10px] font-black uppercase tracking-widest text-[var(--text-secondary)]">Actor</div>
          <div className="col-span-3 text-[10px] font-black uppercase tracking-widest text-[var(--text-secondary)] text-right">Timestamp</div>
        </div>
        ...
        {loading ? (
          <div className="p-20 flex flex-col items-center justify-center gap-4">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[var(--text-secondary)] animate-pulse">Decrypting Logs...</span>
          </div>
        ) : logs.length === 0 ? (
          <div className="p-20 flex flex-col items-center justify-center gap-4 opacity-50">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[var(--text-secondary)]">No events recorded yet</span>
          </div>
        ) : (
              ...
              <div key={log.$id}
                ...
                <div className="col-span-3 flex items-center gap-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[8px] font-medium text-[var(--text-secondary)] uppercase tracking-widest">{log.actor === 'system' ? 'Automated' : 'Manual'}</p>
                  </div>
                </div>

...
import TicketStatsSummary from '../components/TicketStatsSummary';
import {
  LayoutGrid, List, Search, Plus, Bug, ShieldAlert,
  Clock, Sparkles, AlertOctagon, Link2, ExternalLink,
  ChevronRight, RefreshCw, User, Settings, CheckCircle2
} from 'lucide-react';

...
export type Theme = 'light' | 'dark' | 'eye-protection' | 'snow-light' | 'snow-dark';
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    const [theme, setThemeState] = useState<Theme>(() => {
        ...
        return (['light', 'dark', 'eye-protection', 'snow-light', 'snow-dark'].includes(saved)) ? saved : 'dark';
    });
    ...
    const setTheme = (newTheme: Theme) => {
        ...
        root.classList.remove('dark', 'eye-protection', 'snow-light', 'snow-dark');
